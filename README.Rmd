...
methods <- guidelines$methods_selected[[1]]
```
...
We wrapped all available methods were wrapped within a common interface, which makes running a method a one-step-process. For running the methods, it is currently necessary to [have docker installed](#installation).
